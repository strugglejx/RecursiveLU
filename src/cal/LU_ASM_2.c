...
#define BLOCK_SIZE_COL 8

/*
        BL_MUL_TR做汇编优化（但不做分块）
*/
...
int __TEST5_org_inverse_matrix_n_Square_9(double *src, double *dst, int n0);

/*********************SQUARE BLOCKING***************************/

inline int LU_Decomposition_BR_9(double *tri, int n, int m, int d)
{
  /*
...
inline int LU_Decomposition_TR_Square_9(double *dst, double *tri, int n, int m,
                                        int d)
{
  /*
...
inline int LU_L21_mul_U12_Rectangle_9(double *dst, double *tri, int n, int m,
                                      int d)
{
  // 长方块
...
inline int LU_Decomposition_L_9(double *dst, double *tri, int n, int m, int d)
{
  /*
...
int __TEST5_org_inverse_matrix_n_Rectangle_9(double *src, double *dst, int n)
{
  /*
        LU分解的递归分块算法
  */
  ...
  for (int i = 0; i < loop_count; i++)
  {
    int temp1 = (n + 1) * d * i;
    int temp2 = n - d * i;
    LU_Decomposition_L_9(dst + temp1, dst + temp1, n, temp2, d);
    LU_Decomposition_TR_Square_9(dst + temp1, dst + temp1, n, temp2, d);
    LU_L21_mul_U12_Rectangle_9(dst + temp1, dst + temp1, n, temp2, d);
  }

  LU_Decomposition_BR_9(dst + loop_count * d * (n + 1), n, n - loop_count * d, d);
}
